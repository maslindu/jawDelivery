    ...
    <div class="auth-buttons">
        ...
        @auth
            @php
                ...
                $isRegularUser = !$isAdmin && !$isDriver;
            @endphp

            {{-- Tampilkan tombol Home untuk semua user yang login, kecuali di halaman home masing-masing --}}
            @if (
                ($isAdmin && !Request::is('admin')) ||
                    ($isDriver && !Request::is('driver') && !Request::is('driver/dashboard')) ||
                    ($isRegularUser && !Request::is('dashboard')))
                <div style="display: flex; align-items: center; gap: 10px; font-weight:600">
                    <a href="{{ url($homeUrl) }}"
                        style="text-decoration: none; color: #333; display: flex; align-items: center; gap: 5px;">
